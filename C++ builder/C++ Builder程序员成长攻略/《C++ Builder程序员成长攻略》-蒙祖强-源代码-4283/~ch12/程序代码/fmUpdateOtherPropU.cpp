...
bool __fastcall TfmUpdateOtherProp::EnsureDatAvalidFun(int nOtherPropertyNum)
{
    for (int i = 0; i < nOtherPropertyNum; i++)
    {
        if (gridOtherProperty->Cells[0][i] == "")
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行权利人姓名不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        if (gridOtherProperty->Cells[1][i] == "")
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行权种类不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        ...
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行房号不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        if (gridOtherProperty->Cells[3][i] == "")
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行间数不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        ...
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行建筑面结不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        if (gridOtherProperty->Cells[5][i] == "")
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行权利价值不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        ...
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行权利存续期限不能为空！").c_str(), "警告", MB_ICONERROR);
            return false;
        ...
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行权利存续期限格式不对！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
        ...
        {
            ::MessageBox(this->Handle, ("第" + IntToStr(i + 1) +
                "行注销日期格式不对！").c_str(), "警告", MB_ICONERROR);
            return false;
        }
